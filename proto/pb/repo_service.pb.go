...
func (x *IdentifierRequest) GetPage() int64 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *IdentifierRequest) GetPageSize() int64 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
var file_repo_service_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x67,
	...
	0x08, 0x70, 0x61, 0x67, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x32, 0xd0, 0x03, 0x0a, 0x0b, 0x52, 0x65,
